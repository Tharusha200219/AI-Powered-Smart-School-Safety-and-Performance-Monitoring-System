...
@section('content')
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4">ds('admin.layouts.app')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="mb-0">{{ __('Attendance Dashboard') }}</h4>
                                <p class="text-sm text-secondary mb-0">{{ __('Real-time attendance monitoring') }} -
                                    {{ now()->format('l, F j, Y') }}</p>
                            </div>
                            <div>
                                <a href="{{ route('admin.management.attendance.create') }}" class="btn btn-primary btn-sm">
                                    <i class="material-symbols-rounded text-sm">add</i> {{ __('Manual Entry') }}
                                </a>
                                <a href="{{ route('admin.management.attendance.index') }}"
                                    class="btn btn-outline-secondary btn-sm">
                                    <i class="material-symbols-rounded text-sm">list</i> {{ __('View All') }}
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">{{ __('Present') }}</p>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-4">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">{{ __('Absent') }}</p>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-4">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">{{ __('Late') }}</p>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-4">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">{{ __('Total Students') }}</p>
                            ...
                            <div class="card-footer p-3">
                                <p class="mb-0"><span
                                        class="text-info text-sm font-weight-bolder">{{ __('Active') }}</span>
                                    {{ __('in system') }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <h6>{{ __('Recent Check-Ins') }}</h6>
                                    <button class="btn btn-sm btn-outline-primary" onclick="refreshCheckIns()">
                                        <i class="material-symbols-rounded text-sm">refresh</i> {{ __('Refresh') }}
                                    </button>
                                </div>
                            </div>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        ...
                                                        @if ($attendance->is_late)
                                                            <i class="material-symbols-rounded text-warning text-sm"
                                                                title="{{ __('Late arrival') }}">schedule</i>
                                                        @endif
                                                    </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6" class="text-center py-4">
                                                        <p class="text-secondary mb-0">{{ __('No check-ins yet today') }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            @endforelse
    ...
    <script>
        function refreshCheckIns() {
            // Simple page reload for now - can be enhanced with AJAX
