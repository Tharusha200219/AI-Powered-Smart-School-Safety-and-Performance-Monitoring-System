                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    @if (checkPermission('admin.setup.role.form'))
                                        <a class="btn bg-gradient-dark mb-0" href="{{ route('admin.setup.role.form') }}">
                                            <i class="material-symbols-rounded text-sm me-1">add</i>Create Role
                                        </a>
                                    @endif
                                </div>
                            </div>
