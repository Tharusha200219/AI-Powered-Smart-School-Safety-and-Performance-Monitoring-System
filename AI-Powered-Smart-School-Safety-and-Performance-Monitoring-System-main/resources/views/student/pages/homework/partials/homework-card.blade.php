    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-md-2 text-end">
                @if($type === 'pending')
                <a href="{{ route('admin.student.homework.show', $submission->submission_id) }}" class="btn btn-sm btn-primary">
                ...
                @else
                <a href="{{ route('admin.student.homework.results', $submission->submission_id) }}" class="btn btn-sm btn-outline-success">
