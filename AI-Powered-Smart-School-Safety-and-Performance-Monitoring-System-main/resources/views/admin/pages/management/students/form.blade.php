                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.management.students.enroll') }}" method="POST" id="studentForm"
                                ...
                                <!-- RFID Wristband -->
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header" style="background: linear-gradient(45deg,#6f42c1,#ae87f5);">
                                        <h6 class="mb-0 d-flex align-items-center text-white">
                                            <i class="material-symbols-rounded me-2 icon-size-sm">contactless</i>
                                            RFID Wristband
                                        </h6>
                                    </div>
                                    <div class="card-body">

                                        {{-- Hidden student-id for JS --}}
                                        <input type="hidden" id="rfidHiddenStudentId"
                                            value="{{ $student->student_id ?? '' }}">
                                        {{-- Hidden rfid_uid that gets submitted with the form --}}
                                        <input type="hidden" name="rfid_uid" id="rfid_uid_input"
                                            value="{{ old('rfid_uid', $student->rfid_uid ?? '') }}">

                                        @if (!empty($student->rfid_uid))
                                            {{-- Already assigned --}}
                                            <div id="rfidAssignedSection">
                                                <div class="d-flex align-items-center gap-3 flex-wrap">
                                                    <span class="badge bg-success fs-6 px-3 py-2">
                                                        <i class="material-symbols-rounded me-1"
                                                            style="font-size:1rem;vertical-align:middle">nfc</i>
                                                        <span id="rfidCurrentUidBadge">{{ $student->rfid_uid }}</span>
                                                    </span>
                                                    <button type="button" class="btn btn-sm btn-outline-primary"
                                                        onclick="openRfidModal('{{ $student->student_id }}')">
                                                        <i class="material-symbols-rounded me-1"
                                                            style="font-size:1rem">swap_horiz</i>
                                                        Change Wristband
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-outline-danger"
                                                        onclick="removeRfid('{{ $student->student_id }}','{{ route('admin.management.students.rfid.remove', $student->student_id) }}')">
                                                        <i class="material-symbols-rounded me-1"
                                                            style="font-size:1rem">link_off</i>
                                                        Remove
                                                    </button>
                                                </div>
                                            </div>
                                            <div id="rfidNotAssignedSection" class="d-none">
                                            @else
                                                <div id="rfidAssignedSection" class="d-none">
                                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                                        <span class="badge bg-success fs-6 px-3 py-2">
                                                            <i class="material-symbols-rounded me-1"
                                                                style="font-size:1rem;vertical-align:middle">nfc</i>
                                                            <span id="rfidCurrentUidBadge"></span>
                                                        </span>
                                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                                            onclick="openRfidModal(document.getElementById('rfidHiddenStudentId').value)">
                                                            <i class="material-symbols-rounded me-1"
                                                                style="font-size:1rem">swap_horiz</i>
                                                            Change Wristband
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger"
                                                            onclick="removeRfid(document.getElementById('rfidHiddenStudentId').value,'{{ route('admin.management.students.rfid.remove', ['studentId' => ':id']) }}'.replace(':id',document.getElementById('rfidHiddenStudentId').value))">
                                                            <i class="material-symbols-rounded me-1"
                                                                style="font-size:1rem">link_off</i>
                                                            Remove
                                                        </button>
                                                ...
                                                <div id="rfidNotAssignedSection">
                                        @endif
                                        <div class="d-flex align-items-center gap-3">
                                            <span class="badge bg-secondary fs-6 px-3 py-2">
                                                <i class="material-symbols-rounded me-1"
                                                    style="font-size:1rem;vertical-align:middle">contactless</i>
                                            ...
                                            @else
                                                <span class="text-muted small">Save the student first, then assign a
                                                    wristband.</span>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        {{-- RFID modal --}}
                        @include('admin.pages.management.students.partials.rfid_modal')
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-3 flex-wrap">
                                    ...
                                    @if ($id)
                                        <button type="button" class="btn btn-sm btn-primary"
                                            ...
                                            {{ $hasFaceData ? 'Re-capture Face' : 'Setup Face Recognition' }}
                                        </button>
                                    @else
                                        <span class="text-muted small">
                                            Save the student first, then set up face recognition.
                                        </span>
                                    @endif
                                </div>
                                ...
                                @if ($id)
                                    <p class="text-muted small mt-2 mb-0">
                                        ...
                                        The system will capture 40 images and train a personal recognition model for this student.
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        {{-- Face capture modal --}}
                        @include('admin.pages.management.students.partials.face_capture_modal', ['student' => $student ?? null])
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <x-input name="grade_level" type="select" id="grade_level" title="Grade Level"
                                            :isRequired="true" placeholder="Select Grade Level" :options="$grades"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <x-input name="is_active" type="select" title="Active Status" :isRequired="true"
                                            :options="['1' => 'Yes', '0' => 'No']" :value="old('is_active', $student->is_active ?? '1')" />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="primarySubjects" style="display: none;">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <small class="text-danger d-none" id="firstLanguagePrimaryError">Please
                                                    select one first
                                                    language</small>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <small class="text-danger d-none" id="aestheticPrimaryError">Please select
                                                    one aesthetic
                                                    study</small>
                                            </div>
                                        ...
                                        <div id="secondarySubjects" style="display: none;">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <small class="text-danger d-none" id="firstLanguageSecondaryError">Please
                                                    select one first
                                                    language</small>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <small class="text-danger d-none" id="electiveSecondaryError">Please
                                                    ...
                                                    subjects</small>
                                                <small class="text-muted d-block mt-1">Selected: <span id="electiveCount"
                                                        class="fw-bold">0</span>/3</small>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row g-3" id="streamSelection">
                                                    <div class="col-md-3">
                                                        <div class="form-check border rounded p-3 stream-card"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="stream"
                                                                id="streamArts" value="Arts">
                                                            <label class="form-check-label fw-bold" for="streamArts">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check border rounded p-3 stream-card"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="stream"
                                                                id="streamCommerce" value="Commerce">
                                                            <label class="form-check-label fw-bold" for="streamCommerce">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check border rounded p-3 stream-card"
                                                            data-stream="Science">
                                                            <input class="form-check-input" type="radio" name="stream"
                                                                id="streamScience" value="Science">
                                                            <label class="form-check-label fw-bold" for="streamScience">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check border rounded p-3 stream-card"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="stream"
                                                                id="streamTechnology" value="Technology">
...
@section('js')
    ...
    <script>
        ...
        window.rfidEnrollmentStartUrl = @json(route('admin.management.students.rfid.enrollment-start'));
        window.rfidEnrollmentPollUrl = @json(url('/api/rfid/enrollment-poll'));
        window.rfidAssignUrl = @json(route('admin.management.students.rfid.assign'));
    </script>
