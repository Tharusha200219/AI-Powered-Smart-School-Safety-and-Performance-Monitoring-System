                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($id)
                                                <p class="text-muted small mt-2 mb-0">
                                                    ...
                                                    The system will capture 40 images and train a personal recognition model for
                                                    this student.
                                                </p>
                                            @endif
                                        </div>
                                            ...
                                            <div class="row" id="subjectSelectionContainer" style="display: none;">
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="primarySubjects" style="display: none;">
                                                        <h6 class="text-primary mb-3">Primary Education Subject Selection
                                                        </h6>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="firstLanguagePrimaryError">Please
                                                                select one first
                                                                language</small>
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="religionPrimaryError">Please
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="aestheticPrimaryError">Please select
                                                                one aesthetic
                                                                study</small>
                                                        </div>
                                                    ...
                                                    <div id="secondarySubjects" style="display: none;">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="firstLanguageSecondaryError">Please
                                                                select one first
                                                                language</small>
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="religionSecondaryError">Please
                                                                select one religion</small>
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none"
                                                                id="electiveSecondaryError">Please
                                                    ...
                                                    <div id="advancedSubjects" style="display: none;">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <small class="text-danger d-none" id="streamError">Please select
                                                                a
                                                                stream</small>
                                                        </div>
