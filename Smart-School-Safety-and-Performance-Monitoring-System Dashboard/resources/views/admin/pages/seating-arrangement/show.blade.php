                                    ...
                                    <div class="d-flex">
                                        <div
                                            ...
                                            <i class="material-symbols-rounded opacity-10"
                                                style="font-size: 24px;">school</i>
                                        </div>
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold opacity-7">Class</p>
                                                <h6 class="font-weight-bolder mb-0">Grade {{ $arrangement->grade_level }} -
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex">
                                        <div
                                            ...
                                            <i class="material-symbols-rounded opacity-10"
                                                style="font-size: 24px;">groups</i>
                                        </div>
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold opacity-7">Students
                                                </p>
                                                <h6 class="font-weight-bolder mb-0">
                                                    {{ $arrangement->seatAssignments->count() }} Assigned</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex">
                                        <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                            <i class="material-symbols-rounded opacity-10"
                                                style="font-size: 24px;">event_seat</i>
                                        </div>
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold opacity-7">Total
                                                    Seats</p>
                                                <h6 class="font-weight-bolder mb-0">
                                                    {{ $arrangement->seats_per_row * $arrangement->total_rows }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex">
                                        <div
                                            ...
                                            <i class="material-symbols-rounded opacity-10"
                                                style="font-size: 24px;">calendar_today</i>
                                        </div>
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold opacity-7">Academic
                                                    Year</p>
                                ...
                                <div class="seating-grid">
                                    @for ($row = 1; $row <= $arrangement->total_rows; $row++)
                                        <div class="seat-row mb-3 d-flex justify-content-center gap-2">
                                            <span class="row-label text-sm font-weight-bold me-2">Row
                                                {{ $row }}</span>
                                            @for ($seatInRow = 1; $seatInRow <= $arrangement->seats_per_row; $seatInRow++)
                                                @php
                                                    // Calculate the actual seat number (sequential across all rows)
                                                    $actualSeatNumber =
                                                        ($row - 1) * $arrangement->seats_per_row + $seatInRow;

                                                    // Find assignment by row and actual seat number
                                                    $assignment = $arrangement->seatAssignments->first(function (
                                                        $item,
                                                    ) use ($row, $actualSeatNumber) {
                                                        return (int) $item->row_number === (int) $row &&
                                                            (int) $item->seat_number === (int) $actualSeatNumber;
                                                    });
                                                @endphp
                                                        ...
                                                        <div class="card border">
                                                            <div class="card-body p-2 text-center">
                                                                <i class="material-symbols-rounded text-secondary"
                                                                    style="font-size: 20px;">event_seat</i>
                                                                <div class="text-xs text-secondary mt-1">Empty</div>
                                                                <small class="text-xxs text-secondary">Seat
                                                                    {{ $seatInRow }}</small>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <p class="text-xs text-secondary mb-0">
                                                                {{ $assignment->student->student_code }}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="badge bg-gradient-info">
                                                        Row {{ $assignment->row_number }}, Seat
