    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('management')->name('management.')->group(function () {
            ...
            Route::prefix('video-threat')->name('video-threat.')->controller(\App\Http\Controllers\Admin\Management\VideoThreatController::class)->group(function () {
                Route::get('/', 'index')->name('dashboard');
                Route::get('/stats', 'getStats')->name('stats');
                Route::get('/feeds', 'getFeeds')->name('feeds');
            });
            ...
            Route::prefix('audio-video-threat')->name('audio-video-threat.')->controller(\App\Http\Controllers\Admin\Management\AudioVideoThreatController::class)->group(function () {
                Route::get('/', 'index')->name('dashboard');
                Route::get('/stats', 'getStats')->name('stats');
                Route::get('/combined-alerts', 'getCombinedAlerts')->name('combined-alerts');
            });

            // Placeholder Management Routes
            Route::get('homework/dashboard', [PlaceholderController::class, 'homework'])->name('homework.dashboard');
            Route::get('performance/dashboard', [PlaceholderController::class, 'performance'])->name('performance.dashboard');
            Route::get('reports', [PlaceholderController::class, 'reports'])->name('reports.index');
        });
