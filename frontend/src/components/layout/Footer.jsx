...
const Footer = () => {
  ...
  return (
    <footer className="relative primary-gradient-bg text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div className="group">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-2xl font-bold primary-gradient">
                Manuel Dala
              </h2>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'Projects', 'Services', 'Blog'].map((link) => (
                <li key={link}>
                  <a
                    href="#"
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <a href="mailto:manueljosedala@hotmail.com" className="text-white hover:text-blue-400 transition">
              ...
              <li className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <a href="tel:+244941540352" className="text-white hover:text-blue-400 transition">
                    +244 941 540 352
                  </a>
                </div>
              </li>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; <span id="year" className="text-blue-400"></span> Manuel Dala. All rights reserved.
          </p>
          <div className="flex space-x-6">
            {['Privacy Policy', 'Terms of Service', 'Cookies'].map((link) => (
              <a key={link} href="#" className="text-gray-400 hover:text-white transition">
                {link}
              </a>
            ))}
          </div>
      ...
      <style>{`
        ...
        .primary-gradient-bg {
          background: linear-gradient(195deg, #E94C1D 0%, #D70075 100%);
        }
      `}</style>
    </footer>
  );
