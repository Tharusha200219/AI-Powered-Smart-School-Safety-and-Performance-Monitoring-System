...
import logo from "../../assets/258.png";
const navigation = [
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? "after:scale-x-100 primary-gradient"
                        : "text-gray-400 hover:text-black after:scale-x-0 hover:after:scale-x-100 after:bg-black/20 primary-gradient-transparent",
